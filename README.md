...
## Connect With Me  
- **LinkedIn:** [Pranav Grover](https://www.linkedin.com/in/pranav-grover-utd)  
- **GitHub:** [Pranav Grover](https://github.com/pranavgrover)  
...
This project is maintained by Pranav Grover, a Data Analyst with 2+ years of professional experience in data engineering, dashboard development, and translating data into actionable insights. Pranav specializes in using tools like Power BI, SQL, and Python to build robust analytical solutions. Currently pursuing an MS in Business Analytics and AI at UT Dallas, Pranav is dedicated to developing and enhancing data-driven projects.